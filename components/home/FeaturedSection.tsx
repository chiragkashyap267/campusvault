      ...
      <div className="container-app space-y-20">
        ...
        <div>
          ...
          {loadingTrending ? (
            ...
            <EmptySection message="No trending resources yet. Be the first to upload!" />
          )}
        </div>
...
function SectionHeader({
  ...
  return (
    <div className="flex items-end justify-between mb-6">
      ...
      <Link
        href={href}
        className="flex items-center gap-1 text-sm text-slate-400 hover:text-cyan-400 transition-colors group"
      >
        View all
